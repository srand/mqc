...
const file_helloworld_proto_rawDesc = "" +
	...
	"\aGreeter\x12>\n" +
	"\bSayHello\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply\"\x00BE\n" +
	"\x1bio.grpc.examples.helloworldB\x0fHelloWorldProtoP\x01Z\x13examples/helloworldb\x06proto3"
